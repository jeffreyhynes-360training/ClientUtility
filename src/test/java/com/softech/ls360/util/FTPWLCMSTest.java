...
public class FTPWLCMSTest{
    ...
    @Test
    public void verifyWLCMSUploadUtility() throws IOException{
        ...
        String filename = "SampleVideo_1080x720_1mb.flv";
        String finalPath = "TemporaryAssets/99";
        String fullRemotePath = "TemporaryAssets/99/SampleVideo_1080x720_1mb.flv";

        String imageFilePath = "Movie/SampleVideo_1080x720_1mb.flv";
        byte[] fileArray = FileUtils.load(getClass().getClassLoader().getResourceAsStream(imageFilePath));
        try{
    ...
    public void verifyWLCMSCreateDirectoryUtility(){
        ...
        assertTrue(ftpUtil.directoryExists(client,serverPath));
